 ...
 * @returns {{webpackConfig: string|void}} Object containing path to a webpack config file, if any
 */
 ...
 * @returns {{tsConfig: string|void}} Object containing path to a TS config file, if any
 */
